...
func TestFailAgree3B(t *testing.T) {
	...
	// disconnect one follower from the network.
	fmt.Println("disconnect one follower from the network.")
...
func TestFigure8Unreliable3C(t *testing.T) {
	...
	//fmt.Println("CHOUCHOUCHOUCHOUCHOUCHOUCHOUCHOUBAO")
	for i := 0; i < servers; i++ {
